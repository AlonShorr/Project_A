...
{
    initArduino();
    std::printf("Micromouse started!\n");
    // --- PIN DEFINITIONS ---
    // Left Motor (BIN1/BIN2)
    // const gpio_num_t L_BIN1 = GPIO_NUM_17; // The "problem" pin
    // const gpio_num_t L_BIN2 = GPIO_NUM_32;
    
    // // Right Motor (AIN1/AIN2) - CONFIRMED: 33 and 27
    // const gpio_num_t R_AIN1 = GPIO_NUM_33; 
    // const gpio_num_t R_AIN2 = GPIO_NUM_27;

    // // --- SAFETY SETUP (Stops the spinning) ---
    // // Configure all pins as outputs
    // gpio_set_direction(L_BIN1, GPIO_MODE_OUTPUT);
    // gpio_set_direction(L_BIN2, GPIO_MODE_OUTPUT);
    // gpio_set_direction(R_AIN1, GPIO_MODE_OUTPUT);
    // gpio_set_direction(R_AIN2, GPIO_MODE_OUTPUT);

    // // Force everything to 0 (STOP) immediately
    // gpio_set_level(L_BIN1, 0);
    // gpio_set_level(L_BIN2, 0);
    // gpio_set_level(R_AIN1, 0);
    // gpio_set_level(R_AIN2, 0);

    // printf("Startup Complete. Motors forced OFF. Starting Sequence in 2 seconds.\n");
    // delay(2000); // Wait 2 seconds before starting tests
    // // Testing sequence
    // // FORWARD 
    // printf("FORWARD 1 Sec\n");
    // gpio_set_level(R_AIN1, 1);
    // gpio_set_level(R_AIN2, 0);
    // gpio_set_level(L_BIN1, 0);
    // gpio_set_level(L_BIN2, 1);
    ...
    // // Right Turn
    // printf("RIGHT TURN 1 Sec\n");
    // gpio_set_level(R_AIN1, 0); // Right motor backwards
    // gpio_set_level(R_AIN2, 1);
    // gpio_set_level(L_BIN1, 0); // Left motor forwards
    // gpio_set_level(L_BIN2, 1);
    // delay(1000); // Run for 1 second
    ...
    // printf("Starting Motor Test in 3 seconds...\n");
    // delay(3000);

    // // --- TEST 1: RIGHT MOTOR FORWARD ---
    // printf("Test: Right Motor FORWARD (Pin 33 High, 27 Low)\n");
    // gpio_set_level(R_AIN1, 1);
    // gpio_set_level(R_AIN2, 0);
    // delay(1500); // Run for 1.5 seconds

    // printf("Test: Right Motor STOP\n");
    // gpio_set_level(R_AIN1, 0);
    // gpio_set_level(R_AIN2, 0);
    // delay(1000);

    // // --- TEST 2: LEFT MOTOR FORWARD---
    // printf("Test: Left Motor FORWARD (Pin 15 High, 32 Low)\n");
    // gpio_set_level(L_BIN1, 0);
    // gpio_set_level(L_BIN2, 1);
    // delay(1500);

    // printf("Test: Left Motor STOP\n");
    // gpio_set_level(L_BIN1, 0);
    // gpio_set_level(L_BIN2, 0);

    //    // --- TEST 3: RIGHT MOTOR BACKWARD ---
    // printf("Test: Right Motor FORWARD (Pin 33 High, 27 Low)\n");
    // gpio_set_level(R_AIN1, 0);
    // gpio_set_level(R_AIN2, 1);
    // delay(1500); // Run for 1.5 seconds
    ...
    // printf("Test: Left Motor FORWARD (Pin 15 High, 32 Low)\n");
    // gpio_set_level(L_BIN1, 1); // backwards
    // gpio_set_level(L_BIN2, 0); // forwards
    // delay(1500);
    ...
    // Localization init
    // Convert the 'maze_map' (std:array) into a std::vector for our init
    std::vector<segment::Segment> map_segments;
    for (const auto& seg : maze_map) {
